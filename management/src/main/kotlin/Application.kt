...
fun Application.module() {
    ...
    configureRouting(globalContext.get(), jwtConfig, globalContext.get(), globalContext.get(), globalContext.get(), globalContext.get(), globalContext.get(), globalContext.get())
}
